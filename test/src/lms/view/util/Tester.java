 ...
 * 
 * Test data utility for the View
 */
...
public class Tester {   
   ...
   // populate the supplied Model with test Holdings
   ...
   // store holdings in the Library Collection
   private void addHoldings(LMSModel model) {
